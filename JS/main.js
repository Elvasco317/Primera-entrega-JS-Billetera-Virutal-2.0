...
while (operaciones != 6) {
    switch (operaciones) {
        ...
        case 2:
            console.log(
                " ALIAS: elvasco317.mp \n N° CUENTA: 1254834100001 \n CBU: 2155000743285454687987 \n CUIT: 20-32251669-0"
            );
            break;
        case 3:
            let deposito = parseInt(prompt("Cuanto desea depositar: $"));
            let nuevoSaldoDeposito = sumar(saldo, deposito);
            console.log("Su nuevo saldo es: $" + nuevoSaldoDeposito + "\nGracias por usar billetera 2.0");
        ...
        case 4:
            ...
            if (saldo >= extraccion) {
                ...
                console.log("Su nuevo saldo es: $" + nuevoSaldoExraccion + "\nGracias por usar nuestros servicios");
        ...
        case 5:
            ...
            if (cuotas == 12) {
                ...
                console.log("Prestamo: $" + prestamo + "\nCantidad cuotas: " + cuotas + "\nMonto cuota: $ " + cuotaFinal);
            } else if (cuotas == 18) {
                let montoFinalPrestamo = calculaPrestamo(prestamo, interesDieciochoCuotas);
                let cuotaFinal = cuotaFinalPrestamo(montoFinalPrestamo, cuotas);
                console.log("Prestamo: $" + prestamo + "\nCantidad cuotas: " + cuotas + "\nMonto cuota: $ " + cuotaFinal);
            } else if (cuotas == 24) {
                let montoFinalPrestamo = calculaPrestamo(prestamo, interesVeinticuatroCuotas);
                let cuotaFinal = cuotaFinalPrestamo(montoFinalPrestamo, cuotas);
                console.log("Prestamo: $" + prestamo + "\nCantidad cuotas: " + cuotas + "\nMonto cuota: $ " + cuotaFinal);
            } else {
            ...
            break;
        default:
            console.log("Seleccione un numero valido de operación dentro del listado");
    }
    operaciones = parseInt(prompt("Seleccione una operacion a realizar: \n 1- Consultar Saldo,\n 2- Datos de mi cuenta, \n 3- Depositos,\n 4- Extracciones,\n 5-Prestamos, \n 6- Salir ")
    );
}